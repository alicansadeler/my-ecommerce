...
export const CarouselHeader = () => {
  ...
  return (
    <>
      <div className="bg-lineer-blue  flex flex-col items-center justify-around gap-10 m-2 rounded-[20px] mt-20 font-montserrat lg:mx-16 lg:mt-10 lg:flex-row lg:text-left lg:justify-around">
